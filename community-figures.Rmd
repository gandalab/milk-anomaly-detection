...
# decontam input:
# rows = samples, organisms = columns
...
contaminants = isContaminant(microbes_w_controls_t_ceiling, neg = neg_labels, threshold = 0.5, normalize = FALSE)
